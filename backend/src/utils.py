...
def test_get_cropped_name():
    image_path = "C:\\Users\\paulc\\Documents\\GitHub\\PaulsHappyPlace\\tests\\red\\red1.jpg"
    base_folder = "C:\\Users\\paulc\\Documents\\GitHub\\PaulsHappyPlace\\tests\\red-extract"
    cropped_path = get_cropped_name(image_path, base_folder)
    # use assertion
    assert (
        cropped_path
        == "C:\\Users\\paulc\\Documents\\GitHub\\PaulsHappyPlace\\tests\\red-extract/red1.png"
    )

    # try a url
    image_path = "https://www.google.com/images/branding/googlelogo/1x/googlelogo_color_272x92dp.png"
    s3_base = "https://s3.amazonaws.com/paulshappyplace"
    base_folder = s3_base + "/tests/red-extract"
    cropped_path = get_cropped_name(image_path, base_folder)
    assert (
        cropped_path
        == "https://s3.amazonaws.com/paulshappyplace/tests/red-extract/googlelogo_color_272x92dp.png"
    )


if __name__ == "__main__":
    test_get_cropped_name()
